...
async function main() {
      ...
      translations: [
        {
          ...
          summary:
            "Аллаһтың берген игіліктеріне шүкір ету жүрекке тыныштық пен береке әкелетіні жайлы уағыз.",
        ...
        },
        {
          ...
          summary:
            "Проповедь о том, как благодарность Аллаху за дарованные блага приносит покой сердцу и баракят в жизнь.",
      ...
      translations: [
        {
          ...
          summary: "Өмірдегі қиыншылықтарға сабыр етудің сауабы мен мәні туралы уағыз.",
        ...
        },
        {
          ...
          summary: "Проповедь о награде и значении терпения перед жизненными трудностями.",
      ...
      translations: [
        {
          ...
          summary:
            "Ата-ана алдындағы парыз бен олармен қарым-қатынасты жақсартудың сауабы туралы уағыз.",
        ...
        },
        {
          ...
          summary:
            "Проповедь о долге перед родителями и о награде за укрепление отношений с ними.",
      ...
      translations: [
        {
          ...
          summary:
            "Сауда-саттықта, сөзде және іс-әрекетте аманатты сақтау мен шыншыл болудың маңызы туралы уағыз.",
        ...
        },
        {
          ...
          summary:
            "Проповедь о важности хранить доверенное и быть правдивым в торговле, речи и поступках.",
      ...
      translations: [
        {
          ...
          summary: "Артынан сөйлеу мен өсек-аяңның зияны және одан сақтанудың жолдары туралы уағыз.",
        ...
        },
        {
          ...
          summary: "Проповедь о вреде злословия за спиной и о том, как уберечься от этого греха.",
  ...
  const blocks: Block[] = [
    ...
    },
    {
      ...
      order: 2,
      translations: [
        { locale: "kk", title: "Мешітке ерте келу", body: "Уағыз басталғанға дейін мешітке ерте келіп, дұға мен зікірмен уақыт өткізу үлкен сауапты іс." },
        { locale: "ru", title: "Прийти в мечеть заблаговременно", body: "Прийти в мечеть заранее, до начала проповеди, и провести время в мольбе и поминании Аллаха — большое благо." },
